...
public class ReleaseBlogController extends HttpServlet {
    ...
    public String addBlogInfo(@RequestParam("userId") String userId, @RequestParam("blogTitle") String blogTitle,
                              ...
                              @RequestParam("blogAttachmentDownload") MultipartFile blogAttachment,@RequestParam("courseId") String courseId,
...
//        Txt2PDF.exportPDF(response, blogTitle, blogContent, pdfPath);
        try {
