...
@Alias("courseTestPaperDO")
public class CourseTestPaperDO {
    private int pkId;
    private int courseId;
    private String paperName;
    private String download;

    public CourseTestPaperDO() {
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof CourseTestPaperDO)) return false;
        final CourseTestPaperDO other = (CourseTestPaperDO) o;
    ...
    private boolean canEqual(final Object other) {
        return other instanceof CourseTestPaperDO;
    }
    ...
    public String toString() {
        return "CourseTestPaperDO(pkId=" + this.pkId + ", courseId=" + this.courseId + ", paperName=" + this.paperName + ", download=" + this.download + ")";
    }
}
