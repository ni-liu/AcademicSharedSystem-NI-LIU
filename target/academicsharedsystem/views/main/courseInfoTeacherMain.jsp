                ...
                <div class="widget-box" style="margin-top: 50px">
                    ...
                    <form class="form-horizontal" action="" style="margin-top: 50px">
                        <div class="col-md-12 form-group">
                            ...
                            <div class="col-sm-3">
                                <input id="uploadExp" class="form-control" type="text" name="expName" placeholder="填写上传实验的名称">
                            </div>
                            <div class="col-sm-3">
                ...
                <div class="widget-box">
                    ...
                    <form class="form-horizontal" action="" style="margin-top: 50px;">
                        <div class="col-md-12 form-group">
                            ...
                            <div class="col-sm-3">
                                <input id="uploadPaperTest" class="form-control" type="text" name="expName" placeholder="填写上传模拟试卷的名称">
                            </div>
                            <div class="col-sm-3">
